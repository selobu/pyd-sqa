...
def test_config() -> None:
    ...
    PydanticUser = pyd_sqa(User, config=config)
    PydanticAddress = pyd_sqa(Address, config=config)
...
def test_exclude() -> None:
    PydanticUser = pyd_sqa(User, exclude={"nickname"})
    PydanticAddress = pyd_sqa(Address, exclude={"user_id"})
